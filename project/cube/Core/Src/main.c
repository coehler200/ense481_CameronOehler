...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, BLE_RST_Pin|BLE_CS_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : BLE_RST_Pin BLE_CS_Pin */
  GPIO_InitStruct.Pin = BLE_RST_Pin|BLE_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pin : BLE_RX_AVAIL_Pin */
  GPIO_InitStruct.Pin = BLE_RX_AVAIL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(BLE_RX_AVAIL_GPIO_Port, &GPIO_InitStruct);
...
__weak void StartReadImu(void *argument)
{
  /* USER CODE BEGIN 5 */
  /* Infinite loop */
  for(;;)
...
__weak void StartCli(void *argument)
{
